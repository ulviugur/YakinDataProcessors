...
public class MockPhraseInQuoteChecker {
    ...
    /*    String targetPhrase = "beti benzi solmak";
    ...
    */    
       /* 
        String targetPhrase = "gözünden yaşlar boşanmak";
        ...
        String quote = "Uzun zamandır böyle duygusal anlar yaşamamıştı. "
        		...
        		+ "Hikâye derinleştikçe, gözlerinden yaşlar boşanıyordu ve kimse onu sakinleştiremedi.";
        */
        
        List<String> results = analysisWrapper.searchPhraseInText(targetPhrase, quote);
        
        if (!results.isEmpty()) {
        	for (String result : results) {
        		log4j.info("Found phrase: " + result);
        	}
        } else {
        	log4j.info("Phrase not found in the quote.");
        }
	}
